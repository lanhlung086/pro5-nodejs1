        ...
        <>
            <>
                ...
                <section className="section main">
                    ...
                    <div className="among-us">
                        <h1>The Staff</h1>
                    </div>
                    <div className="among-us-detail">
                        <div className="container">
                            <div className="big-boss">
                                <h2 className="among-us-title text-center">Our Leader Squad</h2>
                                <div className="boss-pic col-md-4">
                                    <img className="pic-boss" src="../imgs/boss.jpg" />
                                </div>
                                <div className="boss-detail col-md-4">
                                    <h3>Giới Thiệu !!!</h3>
                                    <h4><img src="../imgs/facebook1.png" />Đã làm việc tại MageStore</h4>
                                    <h4><img src="../imgs/facebook.png" />Từng học tại Hanoi University of Science and Technology</h4>
                                    <h4><img src="../imgs/facebook1.png" />Đã học tại thpt ba dinh</h4>
                                    <h4><img src="../imgs/facebook1.png" />Đã học tại thpt ba dinh</h4>
                                    <h4><img src="../imgs/facebook1.png" />Tham gia vào Tháng 4 năm 2010</h4>
                                    <h4><i className="far fa-clock" />SẮP KẾT HÔN </h4>
                                    <h4>Thông Tin Xin Liên Hệ: 0912 ngày mai nói tiếp </h4>
                                    <h4><a href="https://www.facebook.com/quanghoatrinh.inc/">Link FaceBook</a></h4>
                                </div>
                                <div className="boss-pic col-md-4">
                                    <img className="pic-boss" src="../imgs/boss2.jpg" />
                                </div>
                            </div>
